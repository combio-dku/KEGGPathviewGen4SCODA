...
#' @param deg_fc_limit Clipping cutoff for log-fold-chage. Default is 4. 
...
#' @export
save_kegg_pathviews <- function( adata, target_cell, df_pathways_map, pathways = NULL, deg.p.val.cutoff = 0.01, gsa.p.val.cutoff = 0.01, deg.key = 'DEG_vs_ref', gsa.key = 'GSA_vs_ref_up', deg_fc_limit = 4 )
{
    deg_limit = deg_fc_limit
    species <- adata$uns[['usr_param']][['species']]
